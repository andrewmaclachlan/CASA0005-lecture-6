...
.small[Mortality ratio increases from light grey (low mortality) to black (high mortality). Quintile method of categorisation used White municipalities have missing information.. Source:[Lornt et al.2001](https://reader.elsevier.com/reader/sd/pii/S0277953600004561?token=C5F23C3B005AE5E609482CE25240CBDC867C3A88C5D3E6DFA680F5DCA353B6799D0BD26BFDA6BE8E1A55E70684613D8E&originRegion=eu-west-1&originCreation=20220221114112)
]
...
* For example... st_within, st_intersects, st_disjoint...
...
```{r echo=FALSE, out.width='100%', fig.align='center'}
knitr::include_graphics('img/DE-9IM-logoSmall.png')
```
.small[DE-9IM. Source:[Wikipedia](https://en.wikipedia.org/wiki/DE-9IM)
]
]
...
2. Work out the deviation (polygon - mean of neighbours). This is global Moran's I so we use all the values in the spatial data and they are the same (e.g. zone 1 value is 7)
...
* Sum of the deviation (times weight matrix - top of the right part): 36.82 (binary), 16.28 (row standardised)

* Sum of the deviation ^ 2 (bottom of the right part) = 38.83

Plug it in: (units (N)/ sum of weight matrix) * (weight matrix deviation / deviation squared)
  * (6/18) * (36.82/38.83) = 0.32
  * (6/6) * (16.28/38.83) = 0.42 
...
```{r echo=FALSE, out.width='40%', fig.align='center'}
knitr::include_graphics('img/moranIvsgearcyC.png')
```

.small[Moran I and Geary C. Source:[NKU, 2022](https://www.nku.edu/~longa/geomed/ppa/doc/globals/Globals.htm)
]
...
* Similar concept but **just returns a z score**
  ...
  * However....this takes the local sum which is then compared to the **sum of all features**
...
```{r echo=FALSE, out.width='100%', fig.align='center'}
knitr::include_graphics('img/pharmacies_I.png')
```
]
...
```{r echo=FALSE, out.width='100%', fig.align='center'}
knitr::include_graphics('img/pharmacies_Ord.png')
```
]
