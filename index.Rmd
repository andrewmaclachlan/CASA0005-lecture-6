...
.pull-right[
* Probability = Probability of number of plaques in quadrant $$\frac{\lambda^{k}e^{-\lambda}}{k!}$$
* Expected = Expected frequency count on the Poisson distribution 
...
**Row** standardisation is most common if you have polygons. 
...
* Local Moran's I gives a value for each spatial unit in relation to neigbhours and ...
  * Moran's I value
  * Expected Moran's I
  * Variance
...
* We are most interested in the z score here which allows us to state if our value is significantly difference than expected at this location considering the neighours. ]
