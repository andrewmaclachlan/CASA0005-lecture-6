...
* We would expect the probability distribution of X (blue plaques in London) to have a Poisson distribution if they exhibit Complete Spatial Randomness

* We can test for CSR by comparing the observed and expected counts and using a test such as the chi-squared ($𝛸^2$) test
